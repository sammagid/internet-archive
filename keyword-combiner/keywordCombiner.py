...
def create_summarizing_prompt(topics_list):
    ...
    Args:
        topics_list (string[]): A list of topic/frequency list strings, e.g. those
        generated by the bert_keywords(), spacy_keywords(), and yake_keywords() functions.
...
if __name__ == "__main__":
    ...
    # create prompt to summarize all three lists into topics
    prompt = create_summarizing_prompt(keywords_lists)

    # ask chatbot and print answer
    results = askOpenAI(prompt)
    print("\nResults:")
    print(results)
